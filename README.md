...
2. Install the package by the following code. It will run SAMPLE_Thana_Quant_Equity\setup.py for you and install the package with prerequisities.
3. DONE. you can use SAMPLE_Thana_Quant_Equity\src\Thana_strat_tool\indicator for your time-series analysis right away.
``` Terminal
pip install .
```
