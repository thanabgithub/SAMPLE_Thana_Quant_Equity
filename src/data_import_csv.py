...
def df_pivot(
    price_df_: pd.DataFrame, target_var: str, index: str, start_date_, end_date_
):
...
def get_price(input_df: pd.DataFrame, start_date_, end_date_):
    ...
    print("start cal o")
    o_ = (
        df_pivot(preproc_, "open", "datetime", start_date_, end_date_)
        .round(2)
        .astype(np.float64)
    )
    print("start cal h")
    h_ = (
        df_pivot(preproc_, "high", "datetime", start_date_, end_date_)
        .round(2)
        .astype(np.float64)
    )
    print("start cal l")
    l_ = (
        df_pivot(preproc_, "low", "datetime", start_date_, end_date_)
        .round(2)
        .astype(np.float64)
    )
    print("start cal c")
    c_ = (
        df_pivot(preproc_, "close", "datetime", start_date_, end_date_)
        .round(2)
        .astype(np.float64)
    )
    print("start cal v")
    v_ = (
        df_pivot(preproc_, "volume", "datetime", start_date_, end_date_)
        .round(2)
        .astype(np.float64)
    )
    ...
    try:
        ...
        value_ = (
            df_pivot(preproc_, "value", "datetime", start_date_, end_date_)
            .round(2)
            .astype(np.float64)
        )
...
def get_price_value_MKC(input_df: pd.DataFrame, start_date_, end_date_):
    ...
    MKC_ = (
        df_pivot(preproc_, "MKC", "datetime", start_date_, end_date_)
        .round(2)
        .astype(np.float64)
    )
...
def get_benchmark_as_industry_col(
    input_df: pd.DataFrame, start_date_, end_date_, industry_col_
):
    ...
    SET50_ = (
        SET50_.apply(lambda col: indices_df["SET50"].values).ffill(limit=20).fillna(0)
    )

    SET100_ = pd.DataFrame(index=indices_df.index, columns=industry_col_.columns)
    SET100_ = (
        SET100_.apply(lambda col: indices_df["SET100"].values).ffill(limit=20).fillna(0)
    )

    return SET_, SET50_, SET100_


def get_benchmark_v_as_industry_col(
    input_df: pd.DataFrame, start_date_, end_date_, industry_col_
):
    ...
    SET_v_ = (
        SET_v_.apply(lambda col: indices_df["SET_v"].values).ffill(limit=20).fillna(0)
    )

    SET50_v_ = pd.DataFrame(index=indices_df.index, columns=industry_col_.columns)
    SET50_v_ = (
        SET50_v_.apply(lambda col: indices_df["SET50_v"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    SET100_v_ = (
        SET100_v_.apply(lambda col: indices_df["SET100_v"].values)
        .ffill(limit=20)
        .fillna(0)
    )
...
def get_indices(input_df: pd.DataFrame, start_date_, end_date_, o_):
    ...
    SET_ = (
        SET_.apply(lambda col: indices_df["SET"].values)
        .ffill(limit=20)
        .fillna(0)
        .astype(np.float64)
    )
    ...
    SET50_ = (
        SET50_.apply(lambda col: indices_df["SET50"].values)
        .ffill(limit=20)
        .fillna(0)
        .astype(np.float64)
    )
    ...
    SET100_ = (
        SET100_.apply(lambda col: indices_df["SET100"].values)
        .ffill(limit=20)
        .fillna(0)
        .astype(np.float64)
    )
    ...
    I_AGRO_ = (
        I_AGRO_.apply(lambda col: indices_df["I_AGRO"].values)
        .ffill(limit=20)
        .fillna(0)
        .astype(np.float64)
    )
    ...
    I_CONSUMP_ = (
        I_CONSUMP_.apply(lambda col: indices_df["I_CONSUMP"].values)
        .ffill(limit=20)
        .fillna(0)
        .astype(np.float64)
    )
    ...
    I_FINCIAL_ = (
        I_FINCIAL_.apply(lambda col: indices_df["I_FINCIAL"].values)
        .ffill(limit=20)
        .fillna(0)
        .astype(np.float64)
    )
    ...
    I_INDUS_ = (
        I_INDUS_.apply(lambda col: indices_df["I_INDUS"].values)
        .ffill(limit=20)
        .fillna(0)
        .astype(np.float64)
    )
    ...
    I_PROPCON_ = (
        I_PROPCON_.apply(lambda col: indices_df["I_PROPCON"].values)
        .ffill(limit=20)
        .fillna(0)
        .astype(np.float64)
    )
    ...
    I_RESOURC_ = (
        I_RESOURC_.apply(lambda col: indices_df["I_RESOURC"].values)
        .ffill(limit=20)
        .fillna(0)
        .astype(np.float64)
    )
    ...
    I_TECH_ = (
        I_TECH_.apply(lambda col: indices_df["I_TECH"].values)
        .ffill(limit=20)
        .fillna(0)
        .astype(np.float64)
    )
    ...
    I_SERVICE_ = (
        I_SERVICE_.apply(lambda col: indices_df["I_SERVICE"].values)
        .ffill(limit=20)
        .fillna(0)
        .astype(np.float64)
    )
...
def get_indices_v(input_df: pd.DataFrame, start_date_, end_date_, o_):
    ...
    I_AGRO_v_ = (
        I_AGRO_v_.apply(lambda col: indices_df["I_AGRO_v"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_CONSUMP_v_ = (
        I_CONSUMP_v_.apply(lambda col: indices_df["I_CONSUMP_v"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_FINCIAL_v_ = (
        I_FINCIAL_v_.apply(lambda col: indices_df["I_FINCIAL_v"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_INDUS_v_ = (
        I_INDUS_v_.apply(lambda col: indices_df["I_INDUS_v"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_PROPCON_v_ = (
        I_PROPCON_v_.apply(lambda col: indices_df["I_PROPCON_v"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_RESOURC_v_ = (
        I_RESOURC_v_.apply(lambda col: indices_df["I_RESOURC_v"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_TECH_v_ = (
        I_TECH_v_.apply(lambda col: indices_df["I_TECH_v"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_SERVICE_v_ = (
        I_SERVICE_v_.apply(lambda col: indices_df["I_SERVICE_v"].values)
        .ffill(limit=20)
        .fillna(0)
    )
...
def get_member(input_df: pd.DataFrame, start_date_, end_date_):
    ...
    clean_price(preproc_)
    inSET_ = (
        df_pivot(preproc_, "SET", "datetime", start_date_, end_date_)
        .astype(np.float64)
        .replace(0, np.nan)
    )
    inSET50_ = (
        df_pivot(preproc_, "SET50", "datetime", start_date_, end_date_)
        .astype(np.float64)
        .replace(0, np.nan)
    )
    inSET100_ = (
        df_pivot(preproc_, "SET100", "datetime", start_date_, end_date_)
        .astype(np.float64)
        .replace(0, np.nan)
    )
    inI_AGRO_ = (
        df_pivot(preproc_, "I_AGRO", "datetime", start_date_, end_date_)
        .astype(np.float64)
        .replace(0, np.nan)
    )
    inI_CONSUMP_ = (
        df_pivot(preproc_, "I_CONSUMP", "datetime", start_date_, end_date_)
        .astype(np.float64)
        .replace(0, np.nan)
    )
    inI_FINCIAL_ = (
        df_pivot(preproc_, "I_FINCIAL", "datetime", start_date_, end_date_)
        .astype(np.float64)
        .replace(0, np.nan)
    )
    inI_INDUS_ = (
        df_pivot(preproc_, "I_INDUS", "datetime", start_date_, end_date_)
        .astype(np.float64)
        .replace(0, np.nan)
    )
    inI_PROPCON_ = (
        df_pivot(preproc_, "I_PROPCON", "datetime", start_date_, end_date_)
        .astype(np.float64)
        .replace(0, np.nan)
    )
    inI_RESOURC_ = (
        df_pivot(preproc_, "I_RESOURC", "datetime", start_date_, end_date_)
        .astype(np.float64)
        .replace(0, np.nan)
    )
    inI_TECH_ = (
        df_pivot(preproc_, "I_TECH", "datetime", start_date_, end_date_)
        .astype(np.float64)
        .replace(0, np.nan)
    )
    inI_SERVICE_ = (
        df_pivot(preproc_, "I_SERVICE", "datetime", start_date_, end_date_)
        .astype(np.float64)
        .replace(0, np.nan)
    )
...
def get_stock_ROC_1_avg_all__avg_m__avg_p__var_m__var_p__es_m__es_p__max_m__max_p(
    period_: int, start_date_, end_date_
) -> (
    pd.DataFrame,
    pd.DataFrame,
    pd.DataFrame,
    ...
    print(
        "getting get_stock_ROC_1_avg_all__avg_m__avg_p__var_m__var_p__es_m__es_p__max_m__max_p ..."
    )
    period_ = int(period_)
...
def get_industries_alpha_beta_col(benchmark: str, period_: int, start_date_, end_date_):
    period_ = int(period_)
    industy_alpha_ = pd.read_csv(
        "alpha_industry_" + benchmark + "_" + str(period_) + ".csv"
    )
    ...
    industy_beta_ = pd.read_csv(
        "beta_industry_" + benchmark + "_" + str(period_) + ".csv"
    )
...
def get_industries_alpha_beta(benchmark: str, period_: int, start_date_, end_date_, o_):
    industy_alpha, industy_beta = get_industries_alpha_beta_col(
        benchmark, period_, start_date_, end_date_
    )

    I_AGRO_alpha_ = pd.DataFrame(index=industy_alpha.index, columns=o_.columns)
    I_AGRO_alpha_ = (
        I_AGRO_alpha_.apply(lambda col: industy_alpha["I_AGRO"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_AGRO_beta_ = (
        I_AGRO_beta_.apply(lambda col: industy_beta["I_AGRO"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_CONSUMP_alpha_ = (
        I_CONSUMP_alpha_.apply(lambda col: industy_alpha["I_CONSUMP"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_CONSUMP_beta_ = (
        I_CONSUMP_beta_.apply(lambda col: industy_beta["I_CONSUMP"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_FINCIAL_alpha_ = (
        I_FINCIAL_alpha_.apply(lambda col: industy_alpha["I_FINCIAL"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_FINCIAL_beta_ = (
        I_FINCIAL_beta_.apply(lambda col: industy_beta["I_FINCIAL"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_INDUS_alpha_ = (
        I_INDUS_alpha_.apply(lambda col: industy_alpha["I_INDUS"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_INDUS_beta_ = (
        I_INDUS_beta_.apply(lambda col: industy_beta["I_INDUS"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_PROPCON_alpha_ = (
        I_PROPCON_alpha_.apply(lambda col: industy_alpha["I_PROPCON"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_PROPCON_beta_ = (
        I_PROPCON_beta_.apply(lambda col: industy_beta["I_PROPCON"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_RESOURC_alpha_ = (
        I_RESOURC_alpha_.apply(lambda col: industy_alpha["I_RESOURC"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_RESOURC_beta_ = (
        I_RESOURC_beta_.apply(lambda col: industy_beta["I_RESOURC"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_TECH_alpha_ = (
        I_TECH_alpha_.apply(lambda col: industy_alpha["I_TECH"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_TECH_beta_ = (
        I_TECH_beta_.apply(lambda col: industy_beta["I_TECH"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_SERVICE_alpha_ = (
        I_SERVICE_alpha_.apply(lambda col: industy_alpha["I_SERVICE"].values)
        .ffill(limit=20)
        .fillna(0)
    )
    ...
    I_SERVICE_beta_ = (
        I_SERVICE_beta_.apply(lambda col: industy_beta["I_SERVICE"].values)
        .ffill(limit=20)
        .fillna(0)
    )
